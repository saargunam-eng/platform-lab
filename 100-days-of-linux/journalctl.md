What is the purpose of 'journalctl' and how do you use it effectively to debug systemd service failures?
...
On long-running instances, the journal can grow large. Key config in /etc/systemd/journald.conf:
